...
class TokenTransferFrom extends Component {
  ...
  handleSubmit = (event) => {
    ...
    if (this.drizzleStatus.initialized) {
      const stackId = this.contracts.ethritageToken.methods.transferFrom.cacheSend(
        this.state.addressFrom, this.state.addressTo, this.state.tokenId
      );
...
TokenTransferFrom.contextTypes = {
  drizzle: PropTypes.object
};

export default TokenTransferFrom;
