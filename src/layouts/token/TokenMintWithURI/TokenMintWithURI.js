...
class TokenMintWithURI extends Component {
  ...
  handleSubmit = (event) => {
    ...
    if (this.drizzleStatus.initialized) {
      const stackId = this.contracts.ethritageToken.methods.mintWithTokenURI.cacheSend(
        this.state.address, this.state.tokenId, this.state.URI
      );
...
TokenMintWithURI.contextTypes = {
  drizzle: PropTypes.object
};

export default TokenMintWithURI;
